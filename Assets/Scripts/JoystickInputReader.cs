...
public class JoystickInputReader : MonoBehaviour
{
    ...
    public static void SaveToFile()
    {
        ...
        string destination = System.Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "/My Games/FPV Battle/JoystickInputSettings.dat";
    ...
    public static void LoadFromFile()
    {
        ...
        {
            Debug.LogError($"File version is different {inputParameters.version} vs. {currentVersion} {destination}");
            File.Delete(destination);
            return;
        }
